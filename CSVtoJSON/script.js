...
var countries={};
countries["France"]=[0,0];
countries["United Kingdom"]=[0,0];
countries["Germany"]=[0,0];
countries["United States"]=[0,0];
countries["Australia"]=[0,0];
countries["Canada"]=[0,0];
countries["Spain"]=[0,0];
countries["Netherlands"]=[0,0];
countries["South Africa"]=[0,0];
...
console.log(countries);
 ...
 /*if(namo[i].countries_en == "France")
        {
          countries["France"][0]=namo[i].salt_100g;
          countries["France"][1]=namo[i].sugars_100g;
        }
*/